...
def test_neural_martingale_dual_bounds(device):
    ...
    upper_doob = compute_upper_bound(
        test_paths,
        put_payoff,
        K,
        r,
    ...
    print("=" * 60)
    print(f"{'Method':<25}{'Lower':>10}{'Upper':>10}{'Gap':>10}")
    print("-" * 60)
    print(f"{'LSMC':<25}{lower_bound:>10.4f}{'-':>10}{'-':>10}")
    print(f"{'Doob dual':<25}{lower_bound:>10.4f}{upper_doob:>10.4f}{gap_doob:>10.4f}")
    print(f"{'Scaled dual':<25}{lower_bound:>10.4f}{upper_scaled:>10.4f}{gap_scaled:>10.4f}")
    print(f"{'Neural dual':<25}{lower_bound:>10.4f}{upper_nn:>10.4f}{gap_nn:>10.4f}")
    print("=" * 60)
    ...
    # lower bound must be <= upper bounds
